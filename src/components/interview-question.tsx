...
const InterviewQuestion: React.FC<InterviewQuestionProps> = ({ question }) => {
    ...
    // State Management
    const [currentQuestion, setCurrentQuestion] = useState<InterviewQuestionRecord | null>(question);
    ...
    }, [currentBlob, interview?.id, currentQuestion, updateQuestion, transcribedAudio, evaluateAnswer]);
