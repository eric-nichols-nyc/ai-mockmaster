      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="mb-10 space-y-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl">
            Welcome to your personal interview preparation space. Track your progress, 
            review saved questions, and start new practice sessions.
          </p>
        </div>
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-4 text-sm text-gray-600">
            <div className="px-4 py-2 bg-white rounded-lg shadow">
              <p className="font-semibold">{questionsWithDefaultSaved.length}</p>
              <p>Total Questions</p>
            </div>
