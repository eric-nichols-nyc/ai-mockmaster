    ...
    <div className="container mx-auto p-4">
      ...
      {currentQuestion && (
        <Card className="mb-4">
          ...
          <CardContent>
            <p className="mb-2">
              <strong>Grade:</strong> {currentQuestion.grade}
            </p>
            <p className="mb-2">
              <strong>Your Answer:</strong> {currentQuestion.answer}
            </p>
            <p>
              <strong>Suggested Answer:</strong> {currentQuestion.suggested}
            </p>
            <p className="mb-2">
            ...
            <div className="mb-2">
              ...
              <ul className="list-disc pl-5">
                {currentQuestion.improvements?.map(
            ...
            <div>
              ...
              <ul className="list-disc pl-5">
                {currentQuestion.keyTakeaways?.map(
